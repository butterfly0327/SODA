...
@Entity
@Table(name = "openapi_recommendations")
public class OpenApiRecommendationEntity extends BaseTimeEntity {
    ...
    protected OpenApiRecommendationEntity() {
    }

    public OpenApiRecommendationEntity(ConversationTurnEntity userTurn, String reasonText, JsonNode recommendedItemsJson, String llmModel, RecommendationStatus status, String errorSummary) {
    ...
    public static OpenApiRecommendationEntity create(ConversationTurnEntity userTurn, String reasonText, JsonNode recommendedItemsJson, String llmModel) {
        return new OpenApiRecommendationEntity(userTurn, reasonText, recommendedItemsJson, llmModel, RecommendationStatus.SUCCESS, null);
    }

    public static OpenApiRecommendationEntity createRunning(ConversationTurnEntity userTurn, String llmModel) {
        return new OpenApiRecommendationEntity(
                userTurn,
                null,
    ...
    public static OpenApiRecommendationEntity createPending(ConversationTurnEntity userTurn, String llmModel) {
        return new OpenApiRecommendationEntity(
                userTurn,
                null,
                JsonNodeFactory.instance.arrayNode(),
