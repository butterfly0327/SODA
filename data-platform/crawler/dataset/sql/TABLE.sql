...
-- =========================================================
-- 12-2. dataset_recommendation
-- =========================================================
CREATE TABLE dataset_recommendation (
    id                      BIGSERIAL PRIMARY KEY,
    ...
    CONSTRAINT fk_dataset_recommendation_user_turn
        FOREIGN KEY (user_turn_id) REFERENCES conversation_turn(id) ON DELETE CASCADE,
...
-- =========================================================
-- 12-3. openapi_recommendation
-- =========================================================
CREATE TABLE openapi_recommendation (
    id                      BIGSERIAL PRIMARY KEY,
    user_turn_id            BIGINT       NOT NULL,
    reason_text             TEXT,
    recommended_items_json  JSONB        NOT NULL DEFAULT '[]'::JSONB,
...
CREATE TABLE recommendation (
    ...
    CONSTRAINT fk_recommendation_assistant_turn
        FOREIGN KEY (assistant_turn_id) REFERENCES conversation_turn(id),

    CONSTRAINT fk_recommendation_dataset_recommendation
        FOREIGN KEY (dataset_recommendation_id) REFERENCES dataset_recommendation(id),

    CONSTRAINT fk_recommendation_openapi_recommendation
        FOREIGN KEY (openapi_recommendation_id) REFERENCES openapi_recommendation(id),
...
BEFORE UPDATE ON dataset_recommendation
FOR EACH ROW
EXECUTE FUNCTION set_updated_at();

CREATE TRIGGER trg_openapi_recommendation_set_updated_at
BEFORE UPDATE ON openapi_recommendation
FOR EACH ROW
EXECUTE FUNCTION set_updated_at();
